...
/*	public void testSaludarStringString() throws Exception {
		...
		assertEquals("eu---Manolo", Utilidades.saludar("Manolo", Utilidades.IDIOMA_EUSKERA));
		assertEquals("en---Manolo", Utilidades.saludar("Manolo", Utilidades.IDIOMA_INGLES));
